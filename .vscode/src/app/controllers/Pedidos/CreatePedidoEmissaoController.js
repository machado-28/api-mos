...
class CratePedidoEmissaoController {
    async store(req, res) {
        ...
        await CreatePedidoDeEmissaoUseCase.execute({ requerenteId, fazeId: 1, statusId: 1, tipoVistoId })

        return res.status(201).json({ message: "Pedido Submetido com sucesso!!" })
    }
